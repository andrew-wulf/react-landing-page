...
function App() {
  ...
  let projectData = {
    ripple: {
      title: "Ripple Networking",
      desc: "Networking and Events app, available on iOS and Android. Create a profile, connect with others, and join events to expand your network.",
      imgs: ['rippleRectDark1.png', 'rippleRectDark2.png', 'rippleRectDark3.png'],
      tech: ['Firebase', 'React.JS', 'Capacitor', 'Tailwind'],
      googlePlay: 'https://play.google.com/store/apps/details?id=com.rippleapp.android',
      appStore: 'https://apps.apple.com/us/app/ripple-networking/id6670801663'
    },
    twitter: {
      title: "Twitter Clone",
